<template>
  ...
  >
    <div
      class="zx-xml__preview"
      @click="handlePreview"
    >
      <pre
        v-if="content"
        class="zx-xml__content"
        :style="contentStyle"
      >{{ formattedContent }}</pre>
      <div
        v-else
        class="zx-xml__placeholder"
      >
        <i class="zx-icon-file-xml" />
      </div>
    </div>
    <div
      v-if="showActions"
      class="zx-xml__actions"
    >
      <span
        class="zx-xml__action"
        @click="handlePreview"
      >
...
const formattedContent = computed(() => {
  ...
  try {
    return format(props.content, {
      indentation: ' '.repeat(props.indentation),
