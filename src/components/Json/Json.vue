<template>
  ...
  >
    <div
      class="zx-json__preview"
      @click="handlePreview"
    >
      <pre
        v-if="content"
        class="zx-json__content"
        :style="contentStyle"
      >{{ formattedContent }}</pre>
      <div
        v-else
        class="zx-json__placeholder"
      >
        <i class="zx-icon-file-json" />
      </div>
    </div>
    <div
      v-if="showActions"
      class="zx-json__actions"
    >
      <span
        class="zx-json__action"
        @click="handlePreview"
      >
...
const formattedContent = computed(() => {
  ...
  try {
    ...
    return JSON.stringify(obj, null, props.indentation)
  } catch (error) {
